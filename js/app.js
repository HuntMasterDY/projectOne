    ...
    (() => {
            ...
            menuIcon.forEach((el => {
                if (el) el.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu")) {
                        let block = el.closest(".menu");
                        if (block.closest(".header__menu")) {
                            bodyLockToggle();
                            block.classList.toggle("_active");
                        } else block.classList.toggle("_active");
                    }
                }));
            }));
        }
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new core(".gallery-page__slider_one", {
                    modules: [ Navigation, Scrollbar ],
                    observer: true,
                    observeParents: true,
                    observeSlideChildren: true,
                ...
                new core(".gallery-page__slider_two", {
                    modules: [ Navigation, Scrollbar ],
                    observer: true,
                    observeParents: true,
                    observeSlideChildren: true,
        ...
        if (document.querySelectorAll("[data-simplebar]").length) document.querySelectorAll("[data-simplebar]").forEach((scrollBlock => {
            ...
            psuedo.style.cssText = "height:4px;width:100%;left:0px;right: 0px;background:#0C1417;position:absolute;top: 50%;transform: translate(0%, -50%);z-index:1";
            const elem = scrollBlock.querySelector(".simplebar-horizontal");
            elem.appendChild(psuedo);
        }));
